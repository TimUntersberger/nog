...
pub struct Config {
    ...
    pub remove_title_bar_on_pinned: bool,
...
impl Default for Config {
    fn default() -> Self {
        Self {
            ...
            min_width: 200,
            use_border: true,
            use_border_on_pinned: true,
            outer_gap: 0,
            inner_gap: 0,
            remove_title_bar: true,
            remove_title_bar_on_pinned: false,
            work_mode: true,
            light_theme: false,
            multi_monitor: false,
...
impl Config {
    ...
    pub fn set(&mut self, field: &str, value: &str) {
        match field {
            ...
            "use_border_on_pinned" => self.use_border_on_pinned = value.parse().unwrap(),
            ...
            "remove_title_bar_on_pinned" => self.remove_title_bar_on_pinned = value.parse().unwrap(),
    ...
    pub fn toggle_field(&mut self, field: &str) {
        match field {
            ...
            "use_border_on_pinned" => self.use_border_on_pinned = !self.use_border_on_pinned,
            ...
            "remove_title_bar_on_pinned" => self.remove_title_bar_on_pinned = !self.remove_title_bar_on_pinned,
    ...
    pub fn set_bool_field(&self, field: &str, value: bool) -> Config {
        ...
        match field {
            ...
            "use_border_on_pinned" => config.use_border_on_pinned = value,
            ...
            "remove_title_bar_on_pinned" => config.remove_title_bar_on_pinned = value,

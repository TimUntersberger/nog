...
use interpreter::{Interpreter, Module, Dynamic, Function};
...
lazy_static! {
    ...
    pub static ref INTERPRETER: Mutex<Interpreter> = Mutex::new(Interpreter::new());
    pub static ref CALLBACKS: Mutex<Vec<Function>> = Mutex::new(Vec::new());
}

pub fn add_callback(f: Function) -> usize {
